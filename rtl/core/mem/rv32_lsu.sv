...
module rv32_lsu (
  ...
  assign dmem_if_i.req = data_req_i && !data_err;
  ...
  assign data_ready_o = data_err ? 1'b1 : dmem_if_i.ready;
  assign data_err_o = data_err | (dmem_if_i.ready && dmem_if_i.err);
